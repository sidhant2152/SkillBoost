...
exports.sendOTP = async function (req, res) {
  try {
    ...
    // Now checking if generated otp is unique
    let exists = await OTP.findOne({ otp });
    //we will create OTP till we get unique otp
    while (exists) {
...
exports.signUp = async function (req, res) {
  try {
    // fetch all details from req body
    const {
      email,
      firstName,
      lastName,
    ...
    // Find the most recent OTP corresponding to that mail address
