...
export async function buyCourse(
  ...
  try {
    ...
    // Now Initiate the order
    // We will get the initiated order result from the backend
    ...
    console.log("THIS is response fron capturePayment backend ", orderResponse);

    //Now creating options for our checkout modal
    const options = {
